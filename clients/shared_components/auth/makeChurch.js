        ...
        controller: function(args) {
            return {
                ...
                user:{
                      ...
                      institutionId:m.prop(config.profile.institutionId),
          					},
                    vm:{
                  ...
                  config:function(){
                    ...
                    m(".col s12 z-depth-5 hoverable card-panel",[
                      m("form",{
                        ...
                        onsubmit:function(event){
                          ...
                          setTimeout(function(){
                            m.startComputation();
                              ...
                              var institutionType = config.profile.type
                              ctrl.user.mutate("createUserAddTo" + institutionType,function(res){
                                m.endComputation();
                                console.log(args.verifyLink);
                                console.log(res)
                                m.route(args.verifyLink + "/" + ctrl.user.schema.identifier());
                              },function(err){
                                ...
                                if(err){
                                  ...
                                  console.log("err object from server was not found")
                                }
                        ...
                        m(".row margin",[
                          m(input,{
                            value:ctrl.user.schema.surname,
                            label:"Surname",
                            type:"text",
                            sizes:"s12 m12 l12",
                        ...
                        m(".row margin",[
                          m(input,{
                            value:ctrl.user.schema.othernames,
                            label:"Other Names",
                            type:"text",
                            sizes:"s12 m12 l12",
