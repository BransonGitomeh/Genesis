...
/***/ function(module, exports, __webpack_require__) {
	...
	m.route(document.body, '/', (_m$route = {
	  "/": __webpack_require__(97),
	  "/noticeboard/:uniId": m(layout, {
	    body: __webpack_require__(99)
	  }),
	  "/contactus": __webpack_require__(100),
	  //academics
	  "/academics/ecd": __webpack_require__(101),
	  "/academics/calender": __webpack_require__(102),
	  "/academics/admissions": __webpack_require__(103),
	  "/academics/examinations": __webpack_require__(104),
	  "/academics/liblary": __webpack_require__(105),

	  //operations
	  "/operations/service_charter": __webpack_require__(106),
	  "/operations/governance": __webpack_require__(107),
	  "/operations/HR": __webpack_require__(108),
	  "/operations/finance": __webpack_require__(109),
	  "/operations/downloads": __webpack_require__(110),

	  //proffessional_development
	  "/proffessional_development/ctdc": __webpack_require__(111),
	  "/proffessional_development/shortcourses": __webpack_require__(112),
	  "/proffessional_development/bronchure": __webpack_require__(113),
	  "/proffessional_development/productinformation": __webpack_require__(114),
	...
	}, _defineProperty(_m$route, "/uni/admin/:uniName/:uniId/Students/config/:student_id", m(adminUi, {
	  config: adminConfig,
	  body: __webpack_require__(115)
	})), _defineProperty(_m$route, "/uni/admin/:uniName/:uniId/Students/payments/:student_id", m(adminUi, {
	  config: adminConfig,
	  body: __webpack_require__(79)
	})), _defineProperty(_m$route, "/uni/admin/:uniName/:uniId/Students", m(adminUi, {
	  config: adminConfig,
	  body: __webpack_require__(80)
	})), _defineProperty(_m$route, "/uni/admin/:uniName/:uniId/Students/:course_id/selectLevel", m(adminUi, {
	  config: adminConfig,
	  body: __webpack_require__(82)
	})), _defineProperty(_m$route, "/uni/admin/:uniName/:uniId/Students/:course_id/selectLevel/:level_id/stages", m(adminUi, {
	  config: adminConfig,
	  body: __webpack_require__(84)
	})), _defineProperty(_m$route, "/uni/admin/:uniName/:uniId/Students/:course_id/selectLevel/:level_id/stages/:stage_id/study_mode", m(adminUi, {
	  config: adminConfig,
	  body: __webpack_require__(86)
	})), _defineProperty(_m$route, "/uni/admin/:uniName/:uniId/Students/:course_id/selectLevel/:level_id/stages/:stage_id/study_mode/:study_mode", m(adminUi, {
	  config: adminConfig,
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    ...
	    m("header", {
	      ...
	      class: "brand-logo"
	    }, args.config().logoText ? args.config().logoText : "logoText here")]), m("ul", {
	      class: "right"
	    ...
	    }, "Welcome")]), args.config().sideBarItems.map(function (item) {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  view: function view(ctrl, args) {
	    return m("li", { class: "user-details " + args.color + " darken-3" }, [m(".row", [
	    //pic image
	    m(".col col s4 m4 l4", [m("img", { src: "http://www.imran.com/xyper_images/icon-user-default.png", class: "circle responsive-img profile-image" })]),
	    //dropdown and roal
	    m(".col col s8 m8 l8 black-text", [m("a", {
	    ...
	    }, "Branie", [m("i", { class: "mdi-navigation-arrow-drop-down right" })]), m("ul", {
	      id: "profile-dropdown",
	      class: "dropdown-content",
	      style: "width: 128px; position: absolute; top: 57px; left: 101.234px; opacity: 1; display: none;"
	    }, [m("li", [m("a", [m("i", { class: "mdi-action-face-unlock" })], "Profile")]), m("li", [m("a", [m("i", { class: "mdi-action-settings" })], "Settings")]), m("li", { class: "divider" }), m("li", [m("a", [m("i", { class: "mdi-hardware-keyboard-tab" })], "Log out")])]),
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    ...
	    // header
	    m("a", { class: "collapsible-header" + (ctrl.active() === true ? "active" : "") }, [m("i", { class: args.icon })], args.text),
	    //body
	    m("div", { class: "collapsible-body" }, [m("ul", [args.drops.map(function (drop) {
	      ...
	      }, [m("i", { class: drop.icon }), m("div", drop.text)])]);
	    })])])])]) : m("a", { //render a normal link
	      href: args.link,
	      config: m.route,
	      class: args.link === m.route() ? args.color + " lighten-5" : " "
	    }, [m("i", { class: args.icon }), m("div", args.text)])]);
	  }
	};
...
/***/ function(module, exports) {
	...
	module.exports = {
	  view: function view(ctrl, args) {
	    return m("li", { class: args.url === m.route() ? "active" : " " }, [m("a", {
	    ...
	    }, [args.icon ? m("i", { class: args.icon }) : ""], args.text ? args.text : ""), args.drops ? m("ul", {
	      id: args.text,
	      class: "dropdown-content",
	      config: function config() {
	      ...
	      return m("li", {
	        ...
	        href: drop.url,
	        config: m.route
	      }, [m("i", { class: drop.icon })], drop.text ? drop.text : "")]);
	    })]) : ""]);
	  }
	};
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  view: function view(ctrl, attrs) {
	    ...
	    var select = m(".input-field col s12", m("select", {
	      config: function config() {
	        $('select').material_select();
	        console.log(attrs);
	      },
	      onchange: function onchange(e) {
	        ctrl.schema.selectedCourse(e.target.value), alert(ctrl.schema.selectedCourse());
	      }
	    }, m("option", {
	      value: "",
	      disabled: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			return m(".container row", [args ? "" : m(studentInfo), m(".invoice-header card-panel", [m(".row", [

			// the totals area
			m(".col s12 m3 l12", [m(".row", [m(".col s12 m3 l3 blue white-text right", [
				// m("h4",{class:"header"},"Total Paid: " + ctrl.payments().payments_log.totalPayments)
			])])]), m("h5", "Charges"), m("table", {
				class: "striped"
			}, [m("thead", [m("tr", [m("th", "Semester"), m("th", "Course"), m("th", "Level"), m("th", "Semester"), m("th", "Unit"), m("th", "Date of registration"), m("th", "Cost")])]), m("tbody", [ctrl.payments().units_log.unitsRegistered.map(function (unit) {
				return m("tr", [m("td", unit.tri_semester), m("td", unit.course), m("td", unit.level), m("td", unit.stage), m("td", unit.unit), m("td", moment(unit.date).format('MM/DD/YYYY')), m("td", unit.cost)]);
			})])]), m(".col s12 m3 l12", [m(".row", [m(".col s12 m3 l3 blue white-text right", [m("h6", {
				class: "header"
			}, "Total Charges: " + ctrl.payments().units_log.totalCost)])])]), m("h5", "Payments"), m("table", {
				class: "striped"
			}, [m("thead", [m("tr", [m("th", "Semester"), m("th", "Course"), m("th", "Level"), m("th", "Reciept issued"), m("th", "Payment record date"), m("th", "Channel"), m("th", "Payment Ammount")])]), m("tbody", [ctrl.payments().payments_log.payments.map(function (payment) {
				return m("tr", [m("td", payment.trimester), m("td", payment.course), m("td", payment.level), m("td", payment.receipt), m("td", moment(payment.date).format('MM/DD/YYYY')), m("td", payment.channel + " - " + payment.location), m("td", payment.ammount)]);
			})])]), m(".col s12 m3 l12", [m(".row", [m(".col s12 m3 l3 blue white-text right", [m("h6", {
				class: "header"
			}, "Total payments: " + ctrl.payments().payments_log.totalPayments)])])]), m("br"), m("br"), m(".col s12 m3 l3 blue white-text right", [m("h6", "Current Balance: " + ctrl.payments().balance)])])])]);
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			return m(".row", [m("div", { class: "col s12 m12 l12" }, [
			...
			//              ])
			//          ]),
			m("table", { class: "col s12 m12 l12 stripped" }, [m("thead", [m("tr", [
			// m("th","ID"),
			m("th", { class: "grey white-text" }, ctrl.payment().trisem.name)])])]), m("table", { class: "col s12 m12 l12 stripped" }, [m("thead", [m("tr", [
			// m("th","ID"),
			m("th", "Date"), m("th", "Ammount"), m("th", "Receipt")])]), m("tbody", [ctrl.payment().installments.map(function (installment) {
				return m("tr", [
				// m("td",installment.id),
				m("td", installment.createdAt), m("td", installment.ammount), m("td", installment.receipt)]);
			})]), m("tr", [m("td", { colspan: 2, class: "right" }, m("b", "Total:")), m("td", m("b", ctrl.payment().sum))])])]),
...
/***/ function(module, exports) {
	...
	var links = function links(student) {
		return [{
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			...
			return m(".", [m("." + (args ? args.css : "card"), [m(".col l3", m("b", "Name: "), student.name), m(".col l3", m("b", "Study_mode: "), student.study_mode.name), m(".col l2", m("b", "Course: "), student.course.name), m(".col l2", m("b", "Level: "), student.level.name), m(".col l2", m("b", "Semester: "), student.stage.name)]), m("nav", [m(".nav-wrapper blue", [m("ul", [links(student).map(function (link) {
				return m("li", {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		view: function view(ctrl, atrrs) {
			return m(".card-panelx", [m(".card-stats", [m(".row", [m(card, {
				title: "Students",
...
/***/ function(module, exports) {
	...
	module.exports = {
		view: function view(ctrl, args) {
			return m(".col s12 m6 l3", [m(".card hoverable", [m(".card-content white-text " + args.color, [m("h5", { class: "center card-stats-title" }, [
				// m("i",{class:"mdi-social-group-add"})
			], args.title), m("h5", { class: "center card-stats-number" }, args.number)]), m(".card-action darken-2 " + args.color, [])])]);
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			...
			}, [m("thead", [m("tr", [m("th", "Adm"), m("th", "Names"), m("th", "Course"), m("th", "Level"), m("th", "Stage"), m("th", "Study Mode")])]), m("tbody", [ctrl.results().map(function (result) {
				return m("tr", [m("td", result.adm), m("td", result.name), m("td", result.course.name), m("td", result.level.name), m("td", result.stage.name), m("td", result.study_mode.name), m("td", [m("a", {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  view: function view(controller, atrrs) {
	    return m("div", [m("nav", [m(".nav-wrapper blue", [m(".col s6", [m("a", {
	      class: "breadcrumb"
	    }, "Dashboard"), m("a", {
	      class: "breadcrumb"
	    }, "Noticeboard")])])]), m(".row", [m(".col l12", [m("br"), m(".flow-text left", "Current Noticeboard Items"), m("button", {
	      onclick: function onclick() {
	    ...
	    }, "Create New Notice")])]), m(".row", [m(".col l8", [m(".divider"), controller.noticeboardItems().noticeboard_items.map(function (item) {
	      return m(noticeItem, {
	        id: item.id,
	        title: item.title,
	    ...
	    // m("div","branson")
	    m(".col l4", m(".divider"), m(oldNotices)
	    // m("div","awesome")
	    )])]);
	  }
	};
	...
	module.exports = {
	  view: function view(ctrl, args) {
	    return m("div", {
	      ...
	      class: "right"
	    }, "( shared " + moment.duration(moment(args.createdAt).diff(moment(new Date())), 'milliseconds').humanize() + " ago" + " )")]), m("div", {
	      class: "divider col l12"
	    }), m("div", {
	      class: "col l12"
	    }, [m("p", args.content)]), m("div", {
	      class: "divider"
	    }), m("br"), m("div", [m("div", {
	      class: "col l12"
	    }, [args.deleteBtn === true ? m("span", [
	    //remove
	    m("button", {
	      class: "btn red right",
	      onclick: function onclick() {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  view: function view(controller) {
	    return m("div", [controller.notices().old_noticeboard_items.length > 0 ? m("ul", {
	      class: "collection with-header"
	    }, [m("li", {
	      class: "collection-header blue white-text"
	    }, m("h4", "Past notices")), controller.notices().old_noticeboard_items.map(function (notice) {
	      return m("li", {
	      ...
	      })]), m("br"), m("span", "( shared " + moment.duration(moment(notice.createdAt).diff(moment(new Date())), 'milliseconds').humanize() + " ago" + " )")]);
	    })]) : ""]);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  view: function view(controller, atrrs) {
	    return m(".row", [m(".col l12", [
	    // m("br"),
	    //all admins
	    m("h1", "Current Admins"), m("a", {
	      class: "btn blue right",
	      href: "/uni/admins/" + m.route.param("uniName") + "/" + m.route.param("uniId") + "/add",
	      config: m.route
	    }, "add admin"), m("table", [m("thead", [m("tr", [m("th", "email")])]),
	    // m("td","createdAt")
	    m("tbody", [controller.admins().map(function (admin) {
	      return m("tr", [m("td", admin.identifier),
	      ...
	      }, "revoke admin rights")]), m("td", [m("button", {
	        class: "btn-flat waves-effect waves-cyan waves-block hoverable"
	      }, "View activity")])]);
	    })])]),

	    // revoked admins
	    m("h1", "Access Revoked Admins"), m("table", [m("thead", [m("tr", [m("th", "email")])]),
	    // m("td","createdAt")
	    m("tbody", [controller.revokedAdmins().map(function (admin) {
	      return m("tr", [console.log(admin), m("td", admin.identifier),
	      // m("td",admin.createdAt),
	      m("td", [
	      ...
	      }, "Remove as admin completely")]), m("td", [m("button", {
	        class: "btn-flat waves-effect waves-cyan waves-block hoverable"
	      }, "View activity")])]);
	    })])])])]);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  view: function view(controller, atrrs) {
	    return m(".row", [m("div", { class: "col l8" }, [m("form", {
	      class: "card-panel",
	      onsubmit: function onsubmit(e) {
	        m.request({
	    ...
	    }, [m("h1", { class: "center" }, "Enter new admin user account"), m(inputComponent, {
	      label: "Email",
	      type: "text",
	      sizes: "col l6",
	    ...
	    }, "Create User")])]), m("div", { class: "col l4" }, [m("form", {
	      class: "card-panel",
	      onsubmit: function onsubmit(e) {
	        e.preventDefault();
	        // var move =
	    ...
	    }, [m("h1", { class: "center" }, "Search existing user"), m(inputComponent, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(controller, atrrs) {
	    return m(".row", m(breadcrumb, { crumps: crumps() }), m(schools)
	    // m(schools),
	    // m(schools)
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var schools = [{ id: "1", text: "School of It" }, { id: "2", text: "School of law" }];
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", { class: "col l4" }, [m("form", {
	      class: "row",
	      onsubmit: function onsubmit(e) {
	        e.preventDefault();
	        m.request({
	      ...
	      type: "text",
	      sizes: "s12 m12 l10"
	    }), m(".col l2", m("br"), m(".btn-floating waves-effect waves-light ", m("i", { class: "mdi-content-send blue" })))), m("ul", { class: "collection with-header" }, [m("li", { class: "collection-header blue white-text" }, [m("h4", { class: "task-card-title" }, "Schools")]),
...
/***/ function(module, exports) {
	...
	module.exports = {
			view: function view(controller, attrs) {
					return m("div",
					// m("br"),
					m(".row", [m("nav", { class: "blue" }, m(".nav-wrapper", m(".col s12", attrs.crumps.map(function (crump) {
							return m("a", {
									config: m.route,
									class: "breadcrumb",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		view: function view(controller, atrrs) {
			return m(".row", m(breadcrumb, { crumps: crumps() }), m(courses)
			// m(schools)
			);
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var courses = [{ id: "1", text: "IT" }, { id: "2", text: "BBIT" }];
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", { class: "col l4" }, [m("form", {
	      ...
	      type: "text",
	      sizes: "s12 m12 l10"
	    }), m(".col l2", m("br"), m(".btn-floating waves-effect waves-light ", m("i", { class: "mdi-content-send blue" })))), m("ul", { class: "collection with-header" }, [m("li", { class: "collection-header blue white-text" }, [m("h4", { class: "task-card-title" }, "Courses")]),
	    // m("p",{class:"task-card-date"},"Some other management thing :-)"),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		view: function view(controller, atrrs) {
			return m(".row", m(breadcrumb, { crumps: crumps() }), m(courses), m(levels), m(stages)
			// m(stages)
			// m(schools)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var levels = [{ id: "1", text: "diploma" }, { id: "2", text: "digree" }];
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", { class: "col l4" }, [m("form", {
	      ...
	      type: "text",
	      sizes: "s12 m12 l10"
	    }), m(".col l2", m("br"), m(".btn-floating waves-effect waves-light ", m("i", { class: "mdi-content-send blue" })))), m("ul", { class: "collection with-header" }, [m("li", { class: "collection-header blue white-text" }, [m("h4", { class: "task-card-title" }, "Level")]),
	    // m("p",{class:"task-card-date"},"Some other management thing :-)"),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var stages = [{ id: "1", text: "semester 1" }, { id: "2", text: "semester 1" }, { id: "3", text: "stage 1" }];
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", { class: "col l4" }, [m("form", {
	      ...
	      type: "text",
	      sizes: "s12 m12 l10"
	    }), m(".col l2", m("br"), m(".btn-floating waves-effect waves-light ", m("i", { class: "mdi-content-send blue" })))), m("ul", { class: "collection with-header" }, [m("li", { class: "collection-header blue white-text" }, [m("h4", { class: "task-card-title" }, "Semesters/Terms")]),
	    // m("p",{class:"task-card-date"},"Some other management thing :-)"),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		view: function view(controller, atrrs) {
			return m(".row", m(breadcrumb, { crumps: crumps() }), m(units_selected)
			// m(schools)
			);
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var selectedUnits = [{ id: "2", text: "bbb" }, { id: "3", text: "bbc" }];

	var units = [{ id: "1", text: "bbb" }, { id: "2", text: "bba" }, { id: "3", text: "bbc" }];

	var drops = [{ id: "1", text: "Dep of ECDE" }, { id: "2", text: "Dep of Environment" }];
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", m("div", { class: "col l4" }, [m("form", { class: "row" },
	    // m(inputComponent,{
	    ...
	    //      )
	    //    )
	    m(".input-field col s12", m("select", {
	      config: function config() {
	        $('select').material_select();
	      },
	      onchange: function onchange(e) {
	      ...
	      disabled: true,
	      selected: true
	    }, "Select department for units"), ctrl.departments().departments.map(function (drop) {
	      return m("option", {
	        value: drop.id
	      }, drop.name);
	    })))), m("ul", { class: "collection with-header" }, [m("li", { class: "collection-header blue white-text" }, [m("h4", { class: "task-card-title" }, "Available Units")])]),
	    ...
	    m("h6", { class: "center" }, "Please select a department above")]), m("div", { class: "col l4" }, [m("ul", { class: "collection with-header" }, [m("li", { class: "collection-header blue white-text" }, [m("h4", { class: "task-card-title" }, "Selected Units")]),
	    // m("p",{class:"task-card-date"},"Some other management thing :-)"),
	    ctrl.units_selected().units_i_offer.map(function (unit) {
	      return m("a", {
	        class: "collection-item waves-effect waves-dark",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(controller, atrrs) {
	    return m(".row", m(breadcrumb, { crumps: crumps() }), m(schools), m(departments)
	    // m(schools)
	    );
	  }
	};
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", { class: "col l4" }, [m("form", {
	      ...
	      type: "text",
	      sizes: "s12 m12 l10"
	    }), m(".col l2", m("br"), m(".btn-floating waves-effect waves-light ", m("i", { class: "mdi-content-send blue" })))), m("ul", { class: "collection with-header" }, [m("li", { class: "collection-header blue white-text" }, [m("h4", { class: "task-card-title" }, "Departments")]),
	    // m("p",{class:"task-card-date"},"Some other management thing :-)"),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		view: function view(controller, atrrs) {
			return m(".row", m(breadcrumb, { crumps: crumps() }), m(schools), m(departments), m(choices)
			// m(schools)
			);
		}
	};
...
/***/ function(module, exports) {
	...
	module.exports = {
	    view: function view(ctrl, args) {
	        return m(".row", [m("br"), m("br"), m("br"), m("br"), m("ul", { class: "collection with-header col l3" }, [m("a", {
	            class: "collection-item waves-effect waves-dark ",
	            ...
	            config: m.route
	        }, "Manage Courses")]), m("ul", { class: "collection with-header col l3" }, [m("a", {
	            class: "collection-item waves-effect waves-dark ",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		view: function view(controller, atrrs) {
			return m(".row", m(breadcrumb, { crumps: crumps() }), m(courses), m(levels));
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		view: function view(controller, atrrs) {
			return m(".row", m(breadcrumb, { crumps: crumps() }), m(units_available)
			// m(schools)
			);
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    ...
	    })])]), m("div", { class: "col l4" }, [m("ul", { class: "collection with-header" }, [m("li", { class: "collection-header blue white-text" }, [m("h4", { class: "task-card-title" }, "Selected Units")]),
	    // m("p",{class:"task-card-date"},"Some other management thing :-)"),
	    ctrl.units_selected().units_i_offer.map(function (unit) {
	      return m("a", {
	        class: "collection-item waves-effect waves-dark",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(controller, atrrs) {
	    return m(".row", m(breadcrumb, { crumps: crumps() }), m(units)
	    // m(schools)
	    );
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(controller, atrrs) {
	    return m(".row", m(breadcrumb, { crumps: crumps() }), m(units), m(prices)
	    // m(schools),
	    // m(schools)
	    );
	  }
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", {
	      ...
	      type: "text",
	      sizes: "s12 m12 l10"
	    }), m(".col l2", m("br"), m(".btn-floating waves-effect waves-light ", m("i", {
	      class: "mdi-content-send blue"
	    })))), m("ul", {
	      class: "collection with-header"
	    }, [m("li", {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(controller, atrrs) {
	    return m(".row", m(breadcrumb, { crumps: crumps() }), m(study_modes)
	    // m(schools),
	    // m(schools)
	    );
	  }
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", { class: "col l4" }, [m("form", {
	      ...
	      type: "text",
	      sizes: "s12 m12 l10"
	    }), m(".col l2", m("br"), m(".btn-floating waves-effect waves-light ", m("i", { class: "mdi-content-send blue" })))), m("ul", { class: "collection with-header" }, [m("li", { class: "collection-header blue white-text" }, [m("h4", { class: "task-card-title" }, "Study Modes")]),
	    // m("p",{class:"task-card-date"},"Some other management thing :-)"),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(controller, atrrs) {
	    return m(".row", m(breadcrumb, { crumps: crumps() }), m(tri_sems)
	    // m(schools),
	    // m(schools)
	    );
	  }
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", { class: "col l4" }, [m("form", {
	      ...
	      type: "text",
	      sizes: "s12 m12 l10"
	    }), m(".col l2", m("br"), m(".btn-floating waves-effect waves-light ", m("i", { class: "mdi-content-send blue" })))), m("ul", { class: "collection with-header" }, [m("li", { class: "collection-header blue white-text" }, [m("h4", { class: "task-card-title" }, "Tri-Semesters"), m("p", { class: "task-card-date" }, "Active tri_semester is ", m("u", ctrl.schools().active_tri_semester ? ctrl.schools().active_tri_semester.name : ""))]), ctrl.schools().tri_semesters.map(function (school) {
	      return m("li", {
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", {
	      ...
	      class: "task-card-title"
	    }, "Payment channels")]), ctrl.pay_channels().result.map(function (channel) {
	      return m("a", {
	        class: "collection-item"
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			return m("span", [m("nav", [m(".nav-wrapper blue", [m(".col s6", [m("a", {
				class: "breadcrumb"
			}, "Dashboard"), m("a", {
				class: "breadcrumb"
			}, "All Students")])])]), m("br"), m("div", {
				class: "container"
			}, [m("a", {
				class: "btn right blue",
				href: "/uni/admin/" + m.route.param("uniName") + "/" + m.route.param("uniId") + "/Students",
				config: m.route
			}, "New Student"), m("br"), m("table", [m("thead", [m("tr", [
			// m("th","id"),
			m("th", "name"), m("th", "adm"), m("th", "course"), m("th", "level"), m("th", "stage"), m("th", "study_mode")])]), m("tbody", [ctrl.students().map(function (student) {
				return m("tr", [
				// m("td",student.id),
				m("td", student.adm), m("td", student.name), m("td", student.course ? student.course.name : ""), m("td", student.level ? student.level.name : ""), m("td", student.stage ? student.stage.name : ""), m("td", student.study_mode ? student.study_mode.name : ""), m("td", [m("a", {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			return m(".container row", [m(studentInfo), m(".card-panel", [m(".input-field col s12 l4", [m("select", {
				config: function config() {
					$('select').material_select();
				},
				onchange: function onchange(e) {
				...
				// disabled: true,
				selected: true
			}, "Select trimester"), ctrl.getTri_semesters().tri_semesters.map(function (stage) {
			...
			}))]), m(".input-field col s12 l8", [m("select", {
				config: function config() {
					$('select').material_select();
				},
				onchange: function onchange(e) {
				...
				// disabled: true,
				selected: true
			}, "Select Semester to register to"), ctrl.results().availableStages.map(function (stage) {
				return m("option", {
					value: stage.id,
					// disabled:true,
...
/***/ function(module, exports) {
	...
	module.exports = {
		view: function view(ctrl, args) {
			return m(".switch", [m("label", args.beforeTxt ? args.beforeTxt : args.beforeTxt, m("input[type=checkbox]", {
				onclick: m.withAttr("checked", args.value),
				checked: args.value(),
				onchange: function onchange(e) {
					args.onChange ? args.onChange(args.value()) : "";
				}
			}), m("span", { class: "lever" }), args.afterTxt ? args.afterTxt : args.afterTxt)]);
		}
	};
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			return m("div", [m("h5", "Courses Available"), ctrl.departments().availableCourses.map(function (course) {
				return "ul", [m("li", course.name, [m("button", {
			...
			}), m("h5", "Courses registered to"), ctrl.departments().selectedCourses.map(function (course) {
				return m("li", course.name, [m("button", {
					onclick: function onclick(e) {
						m.request({
							method: "GET",
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", [m("h5", "Available Stages"), ctrl.departments().availableLevels.map(function (course) {
	      return "ul", [m("li", course.name, [m("button", {
	        onclick: function onclick(e) {
	          m.request({
	            method: "GET",
	    ...
	    }), m("h5", "Registered Stages"), ctrl.departments().selectedLevels.map(function (course) {
	      return m("li", course.name, [m("button", {
	        onclick: function onclick(e) {
	          m.request({
	            method: "GET",
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", [m("h5", "Semesters available"), ctrl.departments().availableStages.map(function (course) {
	      return "ul", [m("li", course.name, [m("button", {
	        onclick: function onclick(e) {
	          m.request({
	            method: "GET",
	    ...
	    }), m("h5", "Semesters registered to"), ctrl.departments().selectedStages.map(function (course) {
	      return m("li", course.name, [m("button", {
	        onclick: function onclick(e) {
	          m.request({
	            method: "GET",
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", [m("h5", "Available Units"), ctrl.departments().availableUnits.map(function (course) {
	      return "ul", [m("li", course.name, [m("button", {
	        onclick: function onclick(e) {
	          m.request({
	            method: "GET",
	    ...
	    }), m("h5", "Selected Units"), ctrl.departments().selectedUnits.map(function (course) {
	      return m("li", course.name, [m("button", {
	        onclick: function onclick(e) {
	          m.request({
	            method: "GET",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			return m(".container row", [m(studentInfo), m("form", {
				class: ".row"
			}, [m(".card-panel", [m("form", {
				onsubmit: function onsubmit(e) {
					e.preventDefault();
					m.request({
						...
						return m.route(m.route());
					});
				}
			}, [m(".row", [m(".input-field col s12 l4", [m("select", {
				...
				disabled: true,
				selected: true
			}, "Select Tri-semester"), ctrl.trisemesters().tri_semesters.map(function (drop) {
				return m("option", {
					value: drop.id,
					selected: m.route.param("selectedDepartment") == drop.id ? true : false
				}, drop.name);
			}))]), m(".input-field col s12 l4", [m("select", {
				...
				onchange: function onchange(e) {
					...
					ctrl.payable_semesters().map(function (sem) {
				...
				disabled: true,
				selected: true
			}, "Select semester to pay to"), ctrl.payable_semesters().map(function (stage) {
				return m("option", {
					value: stage.id,
				...
				disabled: true,
				selected: true
			}, "Select Payment Channel"), ctrl.pay_channels().result.map(function (stage) {
				return m("option", {
					value: stage.id,
					selected: m.route.param("selectedDepartment") == stage.id ? true : false
				}, stage.name);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m(".app row", m(".input-field col s12 l3", m(selectCourse)));
	  }
	};
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			return m("select", {
				...
				disabled: true,
				selected: true
			}, "Course for student"), ctrl.courses().map(function (drop) {
				return m("option", {
					value: drop.id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m(".app row", m(".input-field col s12 l3", m(selectCourse), m(selectLevel)));
	  }
	};
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			return m("select", {
				...
				disabled: true,
				selected: true
			}, "Level of the course"), ctrl.selectedCourse().levels.map(function (drop) {
				return m("option", {
					value: drop.id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			return m(".app row", m(".input-field col s12 l3", m(selectCourse), m(selectLevel), m(selectSemester)));
		}
	};
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			return m("select", {
				...
				disabled: true,
				selected: true
			}, "Semester to join"), ctrl.selectedLevel().stages.map(function (drop) {
				return m("option", {
					value: drop.id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m(".app row", m(".input-field col s12 l3", m(selectCourse), m(selectLevel), m(selectSemester), m(selectStudyMode)));
	  }
	};
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			return m("select", {
				...
				disabled: true,
				selected: true
			}, "Select Study mode"), ctrl.studySessions().study_sessions.map(function (drop) {
				return m("option", {
					value: drop.id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m(".app row", m(".input-field col s12 l3", m(selectCourse), m(selectLevel), m(selectSemester), m(selectStudyMode)), m("div", {
	      class: "col s12 l9"
	    }, [m("form", {
	      ...
	      onsubmit: function onsubmit(e) {
	        ...
	        var data = {
	          ...
	          study_mode: m.route.param("study_mode") };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var footer = __webpack_require__(93);
	var sidebar = __webpack_require__(95);
	var pdfobject = __webpack_require__(96);

	module.exports = {
	  view: function view(ctrl, args) {
	    return m(".app", [m.component(navbar), m(".row", [
	    //collumn 1 , the sidebar
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [args.body ? m(args.body) : ""])]), m.component(footer)]);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var navdrop = __webpack_require__(92);
	...
	module.exports = {
	  view: function view(ctrl, args) {
	    ...
	    return m("span", [m("li", {
	      ...
	      id: args.title,
	      class: "dropdown-content"
	    }, [args.drops ? args.drops.map(function (drop) {
	      return m("li", [m("a", {
	        href: drop.url,
	        config: m.route
	      }, drop.title)]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fbPage = __webpack_require__(94);

	module.exports = {
	  view: function view(args) {
	    // return ("div","footer")
	    return m("footer", { class: "page-footer blue" }, [m(".hide-on-med-and-up", [m("br"), m(".container", [m(fbPage, {
	      height: "250px",
	      width: "100%",
	      ...
	      showPosts: "false",
	      facePile: "true"
	    })]), m("br")]), m("div", { class: "footer-copyright" }, "Copyright 2015. Premier ECDE Teachers College. P.O. BOX 3279 Kigali, Rwanda", [m("span", { class: "right" }, "< SSU: 0.3.0 />")])]);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl, attrs) {
	    // console.log(attrs.link.title);
	    var links = [{ title: "Welcome", url: "/" }, { title: "Academic Calender", url: "/academics/calender" }, { title: "Downloads", url: "/operations/downloads" }, { title: "Library", url: "/academics/liblary" }, { title: "Bronchure", url: "/proffessional_development/bronchure" }, { title: "NoticeBoard", url: "/noticeboard/" + appId }, { title: "Service Charter", url: "/operations/service_charter" }];

	    return m("div", [m("div", [
	    //responsive image holder
	    m(".col l12", [m("img[src='images/default/logo.png']", {
	      class: "responsive-img"
	    })]),
	    //latest news header
	    // m("h5",{class:"center"},"Latest News"),
	    //all the links on the sidebar
	    m("ul", { class: "section table-of-contents" }, [links.map(function (link) {
	      return m("li", [m("a", {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  view: function view(ctrl, args) {
	    ...
	    }, [m("p", "It appears you dont have Adobe Reader or PDF support in this web browser. download the document ", [m("a", { href: link }, "here")])]);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var navbar = __webpack_require__(90);
	var sidebar = __webpack_require__(95);
	var nivoslider = __webpack_require__(98);
	var footer = __webpack_require__(93);

	var objectives = [{ text: "To provide education geared toward development of the childs mental, physical and spiritual growth." }, { text: " To provide accessible, affordable and quality childhood education to teachers" }, { text: " To promote the national goals and objectives of Early Childhood Development Education to Rwanda." }];

	module.exports = {
	  view: function view(ctrl) {
	    return m(".app", [m.component(navbar), m(".row", [
	    //collumn 1 , the sidebar
	    m(".col l3 s3 m3  hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9 s12 m12", [m.component(nivoslider),

	    // m("h4",{class:"center blue-text"},"Welcome"),
	    m(".card-panel", [m("p", "Premier ECDE teachers college is an accredited Institution of high learning by the Rwanda government. It started in 2013 with 3 objectives:"), m("ol", [objectives.map(function (objective) {
	      return m("li", objective.text);
	    })]), m(".card-panels", [m("p", "View a detailed product information on what we offer ", [m("a", {
	      href: "/proffessional_development/productinformation",
	      config: m.route
	    }, "here")])]), m(".row", [m(".col l6", [m('h4', { class: "center" }, "Mission"), m("p", "A model institution providing quality early childhood teacher education for africa and beyond.")]), m(".col l6", [m('h4', { class: "center" }, "Vision"), m("p", "To attain world class standard in Early childhood teacher Education training, research and innovation for sustainable individual holistic growth.")])])])])]), m.component(footer)]);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var noticeboard_item = __webpack_require__(37);
	var oldNotices = __webpack_require__(38);
	module.exports = {
	    controller: function controller() {
	        var items = m.request({
	    ...
	    view: function view(ctrl, args) {
	        return m(".noticeboard", [m(".row", [ctrl.items().noticeboard_items.length > 0 ? m(".col l8", [ctrl.items().noticeboard_items.reverse().map(function (item) {
	        ...
	        })]) : m(".loading center", [m("br"), m("br"), m("br"), m("br"), m("br"), m("br"), m("br"), m("br"), m("br"), m(".preloader-wrapper big active", [m(".spinner-layer spinner-blue-only", [m(".circle-clipper left", [m(".circle")]), m(".gap-patch", [m(".circle")]), m(".circle-clipper right", [m(".circle")])])])]), m(".col l4", [m.component(oldNotices)])])]);
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  view: function view(ctrl) {
	    var items = [{ icon: "medium mdi-action-home", text: "P.O. BOX 3279 Kigali, Rwanda" }, { icon: "medium mdi-communication-ring-volume", text: "+250 735 156 902" }, { icon: "medium mdi-communication-stay-current-portrait", text: "+250 783 000 101" }];
	    // var entered_values = []
	    return m(".app", [m.component(navbar), m(".row", [
	    //collumn 1 , the sidebar
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [m("h3", { class: "center" }, "Contact Us"),

	    //  contact links
	    m(".row center", [items.map(function (item) {
	      return m(".col l4", [
	      //  item with logo and info
	      m(".col l3", [m("i", { class: item.icon })]),
	      //  text
	      m(".col l9", [m("p", { class: "flow-text" }, item.text)])]);
	    })])])]),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl) {
	    ...
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [m("h4", { class: "center blue-text" }, "Department of Early Childhood Development"), m("h5", { class: "center" }, "Document on product Information"), m.component(pdfobject, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl) {
	    ...
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [m("h3", { class: "center blue-text" }, "Academic calender"), m("h5", { class: "center" }, "The following is the calender we are using for 2015/2016"), m("h6", { class: "center" }, "Download and feel free to peruce through at your own time"), m.component(pdfobject, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl) {
	    ...
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [m("h3", { class: "center blue-text" }, "Student Admissions"), m("h5", { class: "center" }, "Admissions are open to school based proggrammes"), m("h6", { class: "center" }, "Download and Fill in the following admmision form,then submit to the school administration admisions center"), m.component(pdfobject, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl) {
	    ...
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [m("h3", { class: "center blue-text" }, "Department Of Examinations"), m("h5", { class: "center" }, "Our General Examination Policies"), m.component(pdfobject, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var working_hours = [{ timeName: "Weekdays", duration: "8am-9pm" }, { timeName: "Saturdays", duration: "8am-4pm" }, { timeName: "Sundays and Public Holidays", duration: "Closed" }];
	...
	module.exports = {
	  ...
	  view: function view(ctrl) {
	    ...
	    m("section", [m("h3", { class: "center blue-text" }, "Library"), m("p", "Welcome to our Library, the Library is accessable to users who can freely sample books from the shelves for the purpose of providing accurate, up to date information, sources and resources which support teaching, training, learning and research activities in the college.")]), m(".divider"), m("section", [m("h5", { class: "center" }, "Working Hours"), console.log(working_hours), m("table", { class: "striped" }, [m("thead", [m("th", "TIME"), m("th", "DURATION")]), m("tbody", [working_hours.map(function (hour) {
	      return m("tr", [m("td", hour.timeName), m("td", hour.duration)]);
	    })])])]), m(".divider"),

	    // online books
	    m("section", [m("h5", { class: "center" }, "EBOOKS"), m("p", "E-books Resources, Access over 2 million Electronic books online from ", [m("a[href='http://en.bookfi.net/']", "Bookfi.net")])]), m(".divider"),

	    // E-Journals
	    m(".col l6", [m("section", [m("h5", { class: "center" }, "E-Journals"), m("table", { class: "striped" }, [m("thead", [m("th", "Source"), m("th", "Reason For Recomendation")]), m("tbody", [e_journal_sourses.map(function (source) {
	      return m("tr", [m("td", [m("a", { href: source.url }, source.name)]), m("td", source.explanation)]);
	    })])])]), m(".divider"),

	    // online books
	    m("section", [m("h5", { class: "center" }, "External Links"), m("p", "External Links to other E-content will also be uploaded soon.")]), m(".divider"),

	    // online books
	    m("section", [m("h5", { class: "center" }, "Our Library Rules and Regulations"), m("p", "The Library's prime purpose is to provide information services and materials to the PECDETC community. These library rules and regulations have been formulated to promote fair access and use of library resources and facilities. They shall apply to all library users including PECDETC staff.")]), m(".divider"), m.component(pdfobject, {
	      name: "Library_Rules_and_Regulations.pdf"
	    })]), m(".col l6", [])])]), m.component(footer)]);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl) {
	    ...
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col s12 m9 l9", [m("h3", { class: "center blue-text" }, "Service Charter"), m("h5", { class: "center" }, "we are proud to present our service charter"), m.component(pdfobject, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl) {
	    ...
	    var management_team_members = [{ name: "Kuria S. Gitome", position: "Ag Principal " }, { name: "Mrs. Christine Achieng", position: "Deputy Principal" }, { name: " ", position: "Deputy Principal (Operations)" }, { name: " ", position: "Administrator - Finance" }, { name: "Patience Connie Namudeche", position: "HOD - Early Childhood Education Department" }, { name: " ", position: "HOD - Guidance and Counseling " }, { name: "Miss Kirabo Jocelyn", position: "Ag. Registrar " }];

	    var senate_members = ["The Principal who is the chairperson.", "Deputy Principal (Academic Affairs) responsible for academic affairs who is the Secretary (DP-AA).", "Deputy Principal (Operations).(DP-O).", "Directors of constituent centres", "Deans of student.", "Deans of student.", "Heads of departments", "Librarian", "Marketing officer", "Two student representatives"];
	    return m(".app", [m.component(navbar), m(".row", [
	    //collumn 1 , the sidebar
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [m(".col l6", [m("h4", { class: "center blue-text" }, "Governance"), m("p", "We have very well defined organisation structure that ensures that everything inside the college is decidedin a very organised manner and everyone is accountablefor everything that happens under his docket")]), m(".col l6 center", [m("img", {
	      class: "materialboxed responsive-img",
	      src: "images/default/organogram.jpg",
	      config: function config() {
	        $('.materialboxed').materialbox();
	      }
	    })]), m(".col l12", [m(".row", [m(".col s12", [
	    // tabs header
	    m("ul", {
	      class: "tabs blue",
	      config: function config() {
	    ...
	    titles.map(function (title) {
	      return m("li", { class: "tab col s3 l4 blue white-text waves-effect waves-blue" }, [m("a", { href: "#" + title, class: "white-text" }, title)]);
	    }), m(".indicator white-text waves-effect waves-light")])]),
	    // tabs body, simple divs
	    titles.map(function (title) {
	      if (title === "board") {
	        return m(".col l12", { id: title }, [m("h5", "Our Board Of Directors comprises of the following People"), m("h6", "*To be updated later")]);
	      }

	      if (title === "senate") {
	        return m(".col l12", { id: title }, [m("h5", "Our senate comprises of the following People"), m("ol", [senate_members.map(function (member) {
	          return m("li", [m("div", member)]);
	        })])]);
	      }

	      if (title === "Management_Team") {
	        return m(".col l12", { id: title }, [m("h5", "Our Management Team comprises of the following People"), m("ol", [management_team_members.map(function (member) {
	          return m("li", [m("div", member.position + " - ", [m("b", member.name)])]);
	        })])]);
	      }
	    })])])])]), m.component(footer)]);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl) {
	    ...
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [m("h3", { class: "center blue-text" }, "HR")])]),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl) {
	    ...
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [m("h3", { class: "center blue-text" }, "Finance")])]),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl) {
	    ...
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [m("h3", { class: "center blue-text" }, "Downloads"), m("h5", { class: "center" }, "the following files are available for download"), m("table", { class: "striped centered" }, [m("tbody", [m("tr", [m("td", [m("a", { href: 'http://premiercollege.ac.rw/documents/Student_application_form__.pdf' }, "Application Form")]), m("td", [m("a", { href: 'http://premiercollege.ac.rw/documents/Academic_Calender_2015.pdf' }, "Academic calender 2015/2016")])]), m("tr", [m("td", [m("a", { href: 'http://premiercollege.ac.rw/documents/COLLEGE_SERVICE_CHARTER.pdf' }, "College Service charter")]), m("td", [m("a", { href: 'http://premiercollege.ac.rw/documents/Student_Handbook.pdf' }, "Student Hand Book")])]), m("tr", [m("td", [m("a", { href: 'http://premiercollege.ac.rw/documents/GENERAL_EXAMINATION_POLICY.pdf' }, "General Examination Policy")]), m("td", [m("a", { href: 'http://premiercollege.ac.rw/documents/Library_Rules_and_Regulations.pdf' }, "Library Rules and Regulations")])]), m("tr", [m("td", [m("a", { href: 'http://premiercollege.ac.rw/documents/bronchure.pdf' }, "College Bronchure")]), m("td", [m("a", { href: 'http://premiercollege.ac.rw/documents/Product_Information.pdf' }, "Our services and Products")])])])])])]), m.component(footer)]);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl) {
	    ...
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [m("h4", { class: "center blue-text" }, "Proffessional development Programme"), m("h6", { class: "center" }, "CONTINOUS PROFESSIONAL TEACHER AND COMMUNITY EDUCATION COURSES"), m("table", { class: "striped" }, [
	    //table Head
	    m("thead", [m("tr", [m("th", "Course"), m("th", "Aim"), m("th", "Target Group"), m("th", "Duration"), m("th", "Cost")])]), m("tbody", [courses.map(function (course) {
	      return m("tr", [m("td", course.name), m("td", course.aim), m("td", course.target), m("td", course.duration), m("td", course.cost)]);
	    })])])])]), m.component(footer)]);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl) {
	    ...
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [m("h3", { class: "center blue-text" }, "shortcourses")])]),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl) {
	    ...
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [m("h3", { class: "center blue-text" }, "Bronchure"), m("h5", { class: "center" }, "We are proud to present our bronchure,"), m("h6", { class: "center" }, "Feel free to download and go through at any time, any enqueries should be posted through ", [m("a", {
	      href: "/contactus",
	      config: m.route
	    }, "here")]), m.component(pdfobject, {
	      name: "bronchure.pdf"
	    })])]), m.component(footer)]);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  view: function view(ctrl) {
	    ...
	    m(".col l3 hide-on-med-and-down", [m.component(sidebar)]),
	    //the sider and everything else
	    m(".col l9", [m("h3", { class: "center blue-text" }, "Product Information"),

	    // m("h5",{class:"center"},"We are proud to present our bronchure,"),

	    m("h6", { class: "center" }, "Feel free to download and go through the document at any time, any enqueries should be posted through ", [m("a", {
	      href: "/contactus",
	      config: m.route
	    }, "here")]), m.component(pdfobject, {
	      name: "Product_Information.pdf"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		view: function view(ctrl, args) {
			return m(".app row container", [m(studentInfo), m(".input-field col s12 l12", [m("select", {
				config: function config() {
					$('select').material_select();
				},
				onchange: function onchange(e) {
