...
/***/ function(module, exports) {
	...
	module.exports = function () {
	  var config = {
	    ...
	    color: "blue",
	    topBarItems: [{ url: "/", text: "Home", icon: "mdi-action-view-carousel right" }],
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("li", { class: "collection-item dismissable" }, [m("input", {
	      type: "checkbox",
	      disabled: "disabled",
	    ...
	    }), console.log(args.complete()), m("label", { for: args.text, style: args.complete() ? "text-decoration: line-through;" : "" }, args.text), m("br"), m("span", { class: "task-cat teal" }, args.type ? args.type : ""), m("span", { class: "pink-text right" }, args.due ? args.due : "")]);
	  }
	};
	...
	module.exports = {
		...
		view: function view(controller, atrrs) {
			return m("div", [m("div", {
				...
				class: "flow-text"
			}, "All Registered Churches"), m("a", {
				class: "btn blue right",
				href: "/churchia/new",
				config: m.route
			}, "create new"), m("br"), m("table", [m("thead", [m("tr", [
			// m("th","id"),
			m("th", "name"), m("th", "createdAt")])]), m("tbody", [console.log(controller.churches()), controller.churches().result.map(function (church) {
				return m("tr", [
				// m("td",university.id),
				m("td", church.name), m("td", church.createdAt), m("td", [m("a", {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  view: function view(controller, atrrs) {
	    return m("div", [m("div", { class: "card-panel" }, [m("br"), m("span", { class: "flow-text" }, "All Registered Universities"), m("a", {
	      class: "btn blue right",
	      href: "/uni/new",
	      config: m.route
	    }, "create new"), m("br"), m("table", [m("thead", [m("tr", [
	    // m("th","id"),
	    m("th", "name"), m("th", "createdAt")])]), m("tbody", [controller.universities().map(function (university) {
	      return m("tr", [
	      // m("td",university.id),
	      m("td", university.uniName || university.name), m("td", university.createdAt), m("td", [m("a", {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  view: function view(controller, atrrs) {
	    return m("div", [m("div", { class: "card-panel" }, [m("h1", "welcome to ninja homepage motherfucker"), m("h5", "todo-list"), m("ol", [m("strike", "Add ability to pull all existing universities to home.js"), m("br"), m("li", "Add ability to add a university from the home.js"), m("li", "Add link to each university, to take you to their admin Ui"), m("li", "ted comes to fuck up exponentially")]), m("div", { class: "card-panel" }, [m("blockquote", "fuck you bitches")]), m("nav", { class: "nav-wrapper green" }, [m("a", { class: "brand-logo left" }, "LOGO"), m("ul", { class: "nav-mobile right hide-on-med-and-down" }, [m("li", [m("a", "branie")]), m("li", [m("a", "caroline")]), m("li", [m("a", "ted")]), m("li", [m("a", "awesome")])])]),
	    //nice cute card hehe
	    m("div", { class: "row" }, [m("div", { class: "col s12 m7" }, [m("div", { class: "card yellow darken-3" }, [m("div", { class: "card-content white-text" }, [m("span", { class: "card-title" }, "fuck off"), m("p", { class: "flow-text" }, "this is supposed to be the content")])])])]),
	    //other cute card
	    m("row", [m(".col s12 m6 l6", [m(".card blue-grey darken-1", [m(".card-content white-text", [m("span", { class: "card-title" }, "i am a card title"), m("p", "I am a very simple card. I am good at containing small bits of information.I am convenient because I require litt"), m(".card-action", [m("a", "link 1"), m("a", "link-2")])])])])]), m("div", {
	      class: "btn waves-effect waves-block waves-light purple center",
	      onclick: function onclick() {
	        m.request({ url: apiUrl + "/test2/users", method: "GET" }).then(m.route(m.route()));
	      }
	    }, "initialize server with fake data"), m("br"), m("table", [m("thead", [m("tr", [m("th", "id"), m("th", "name"), m("th", "createdAt"), m("th", "updatedAt")])]), m("tbody", [controller.universities().map(function (university) {
	      return m("tr", [m("td", university.id), m("td", university.name), m("td", university.createdAt), m("td", university.updatedAt), m("td", [m("a", {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  view: function view(ctrl, args) {
	    return m("div", [m("h4", "i am awesome"), m("ul", [ctrl.universities().map(function (uni) {
	      m("li", uni.name);
	    })]), m(card),
	    //m("div",{class:"card-panel"},[
	    m("div", { class: "divider" }), m("div", { class: "row" }, [m("div", { class: "col l6" }, [m("div", { class: "card-panel" }, "column 1")]), m("div", { class: "col l6" }, [m("div", { class: "card-panel" }, "column 2")])]),

	    //]),

	    //m("div",{class:"card-panel"},[
	    m("div", { class: "divider" }), m("div", { class: "row" }, [m("div", { class: "col l6" }, [m("div", { class: "card-panel" }, "column 1")]), m("div", { class: "col l6" }, [m("div", { class: "card-panel" }, "columnl 2")])]),
	    //]),

	    //m("div",{class:"card-panel"},[
	    m("div", { class: "divider" }), m("div", { class: "row" }, [m("div", { class: "col l4" }, [m("div", { class: "card-panel" }, "column 1")]), m("div", { class: "col l4" }, [m("div", { class: "card-panel" }, "column 2")]), m("div", { class: "col l4" }, [m("div", { class: "card-panel" }, "column 3")]),

	    //]),

	    m("div", { class: "divider" }), m("div", { class: "row" }, [m("div", { class: "col l4" }, [m("div", { class: "card-panel" }, "column 1")]), m("div", { class: "col l4" }, [m("div", { class: "card-panel" }, "column 2")]), m("div", { class: "col l4" }, [m("div", { class: "card-panel" }, "column 3")]), m("div", { class: "col l4" }, [m("div", { class: "card-panel" }, "column 4")])])])]);
	  }
	};
	...
	module.exports = {
	  controller: function controller() {
	    return {
	      ...
	      talkSomethingElse: function talkSomethingElse() {
	        alert("my name is caro another");
	      }
	    };
	  },
	  view: function view(ctrl, args) {
	    return m("div", { class: "card-panel" }, [m("h1", { class: "center" }, "my card component"), m("div", { class: "divider" }), m("div", "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."), m("button", {
	      onclick: function onclick() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  view: function view(controller, atrrs) {
	    ...
	    }, "Create New Notice")])]), m(".row", [m(".col l8", [m(".divider"), controller.noticeboardItems().result.map(function (item) {
	      return m(noticeItem, {
	        id: item.id,
	        title: item.title,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  view: function view(controller, atrrs) {
	    return m("span", [m("nav", [m(".nav-wrapper blue", [m(".col s6", [m("a", { class: "breadcrumb" }, "Dashboard"), m("a", { class: "breadcrumb" }, "Noticeboard"), m("a", { class: "breadcrumb" }, "New")])])]), m("form", {
	      class: "container",
	      onsubmit: function onsubmit(e) {
	        m.request({
	          url: apiUrl + "/services",
