var layout = require("./app/pages/onlineChurch/admin/layout")
...
m.route(document.body,"/",{
		...
		"/onlineChurch/admin":m.component(layout, {body: require("./app/pages/onlineChurch/admin/events")}),

		"/onlineChurch/admin/sermons":m.component(layout, {body: require("./app/pages/onlineChurch/admin/sermons")}),
		"/onlineChurch/admin/newSermon":m.component(layout, {body: require("./app/pages/onlineChurch/admin/newSermon")}),
		"/onlineChurch/admin/messages/index":m.component(layout, {body: require("./app/pages/onlineChurch/admin/messages/index")}),
		"/onlineChurch/admin/members":m.component(layout, {body: require("./app/pages/onlineChurch/admin/members")}),



		"/onlineChurch/admin/layout":require("./app/pages/onlineChurch/admin/layout"),
		...
		// main admin console
		"/mainAdmin/makeChurch":require("./app/pages/mainAdmin/makeChurch")
})
