module.exports = [{
    ...
    attributes: {
      ...
      //levels
      //stages
      //units -- can probably attach grades here later
    ...
    attributes: {
      ...
      student_who_made_me:{model:"student"},
      course_paid_to:{model:"course"},
      level_paid_to:{model:"level"},
      stage_paid_to:{model:"stage"},

      tri_semesters_i_was_paid_to:{model:"tri_semester"}
    }
  },{
